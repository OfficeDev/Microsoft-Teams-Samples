...
|6|bot-virtual-assistant|This is a sample application that demonstrates a root bot that routes inputs to skill bots for tailored responses.||[View][bot-virtual-assistant#nodejs]|-
|7|msgext-expert-finder-js|This Teams message extension acts as a plugin for Microsoft Copilot, allowing users to conduct multi-parameter searches for candidates using criteria like skills, location, and availability. It also supports Single Sign-On (SSO) for seamless authentication, ensuring a smooth user experience.||[View][msgext-expert-finder#nodejs]|-
