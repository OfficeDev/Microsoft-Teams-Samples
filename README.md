...
|19| Different Formatting Cards | This sample shows the feature where user can send different formatting on cards using bot. |[View][BotFormattingCards#csharp]|[View][BotFormattingCards#nodejs]
#### Additional samples
