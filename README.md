...
|23| Tab Outlook | This sample shows how to interact with the user's calendar, mail, profile from personal tabs in Outlook.||[View][tab-outlook#ts]|
...
[tab-outlook#ts]:samples/tab-outlook/ts
