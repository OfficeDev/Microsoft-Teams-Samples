...
|4|App identity linking with sso| This sample demos linking user's AAD id with Facebook and google account of user from bot, ME and tab. |[View][identity-linking-with-sso#cs]|
