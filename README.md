...
|12| Archive groupchat message with RSC permissions | Demonstrating on how a bot can archive groupchat messages with RSC and send it to user. | [View][groupchatmessageswithrsc#csharp] |
