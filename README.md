...
|23| Tab calendar in Outlook | This sample shows how to interact with the user's calendar, including opening calendar items and composing meetings from personal tab in Outlook.||[View][tab-calendar#ts]|
