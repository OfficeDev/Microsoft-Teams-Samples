...
|29| Offline Support Tickets |A simple react application for Microsoft Teams. This app allows user to login using SSO and log attendence. ||[View][tab-support-offline#nodejs] ![toolkit-icon](assets/toolkit-icon.png)|
