...
|17| Bot task reminder | Demonstrating feature where user can schedule a task and get reminder on the scheduled date and time | [View][bottaskreminder#csharp] ||
...
[bottaskreminder#csharp]:samples/bot-task-reminder/csharp
