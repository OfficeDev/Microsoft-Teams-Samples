...
|4|Graph API Teams App Catalog Life Cycle | This sample illustrates how you can use [App Catalog Life Cycle](https://docs.microsoft.com/en-us/graph/api/resources/teamsapp?view=graph-rest-1.0) by calling Microsoft Graph APIs. .                              |[View][graph#appctaloglifecycle#cs]       | [View][graph#appcataloglifecycle#js]
