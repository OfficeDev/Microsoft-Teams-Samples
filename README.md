...
|25| Apps in Federated | This sample showcases how apps function within federated group chats. ||[View][bot-feed-members#js] ![toolkit-icon](assets/toolkit-icon.png) 
