...
|13| Archive groupchat messages | Demonstrating on how a bot can archive groupchat messages and send it to user as a file. |  |[View][fetchgroupchatmessages#nodejs]|
