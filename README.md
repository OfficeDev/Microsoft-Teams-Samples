...
|10| Sequential workflow adaptive cards | Demonstrating on how to implement sequential flow, user specific view and upto date adaptive cards in bot. | [View][sequential#workflow#csharp] | [View][bot-sequential-flow-adaptive-cards#js]
...
[bot-sequential-flow-adaptive-cards#js]:samples/bot-sequential-flow-adaptive-cards/nodejs
