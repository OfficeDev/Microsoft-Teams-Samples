...
| 19 | AdhocCalls Transcripts & Recs           | AdhocCalls for group call recording, transcription, and UI display.                                                                                                                                                                             | Intermediate |    |                                             | [View][tab-adhoccalls-transcript-recording#nodejs] ![toolkit-icon](assets/toolkit-icon.png) |                                                                    |
