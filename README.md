...
|:--:|:-------------------|:----------------------------------------------------------------------------------------------|:--------|:-------------|:---------|:--------|
|1|Personal tabs            | This sample app demonstrates how to create a custom personal tab for Microsoft Teams using ASP.NET Core MVC.
...
|5|Channel and group tab quick-start| This sample demonstrates a basic hello world app that features channel and group tabs within Microsoft Teams.                          |                               |[View][group-tab-quickstart#ts] ![toolkit-icon](assets/toolkit-icon.png) |[View][group-tab-quickstart#js] ![toolkit-icon](assets/toolkit-icon.png) |[View](/samples/tab-channel-group-quickstart/js/demo-manifest/tab-channel-group-quickstart.zip) |
...
|10|Deep Link consuming Subentity ID      |This Microsoft Teams sample app demonstrates deeplinks for calls, video, chat, and navigation within tabs and apps. | [View][tab-deeplink#csharp]                       | | [View][tab-deeplink#nodejs] ![toolkit-icon](assets/toolkit-icon.png) |
|11|Integrate graph toolkit component in teams tab      | This sample app showcases a Microsoft Teams tab that utilizes the Microsoft Graph Toolkit to interact with user data and enhance the user experience. |[View][tab-graph-toolkit#csharp]|[View][tab-graph-toolkit#js] ![toolkit-icon](assets/toolkit-icon.png)|
|12|Device permissions      | This Microsoft Teams sample app showcases how to manage device permissions for audio, video, and geolocation within a tab. |                      | [View][tab-device-permissions#js] ![toolkit-icon](assets/toolkit-icon.png) ||[View](/samples/tab-device-permissions/nodejs/demo-manifest/tab-device-permissions.zip)|
...
|18| Tab channel context | This sample application demonstrates how to access and display the tab context object in both private and shared channels within Microsoft Teams. ||[View][tab-channel-context#nodejs] ![toolkit-icon](assets/toolkit-icon.png) |
...
|20| Personal Tab with Nav-Bar menu | This sample demonstrates how to implement a navbar menu in a personal tab app for Microsoft Teams, allowing for multiple actions and an overflow menu. ||[View][tab-navbar-menu#ts] ![toolkit-icon](assets/toolkit-icon.png) |
...
|22| Tab Multi Hub | This sample demonstrates how to interact with Calendar, Mail, Profile, and geolocation features from a personal tabs app in Microsoft Teams. ||[View][tab-multi-hub#ts] ![toolkit-icon](assets/toolkit-icon.png) |
...
|24| Tab External Auth | This Microsoft Teams sample app showcases how to implement Google authentication using OAuth2 with external auth providers. |[View][tab-external-auth#csharp]||
|25| Tab Meeting Tanscript Recording |This sample demonstrates how to capture meeting transcripts and recordings in Microsoft Teams. |[View][tab-meeting-transcript-recording#csharp]|[View][tab-meeting-transcript-recording#nodejs] ![toolkit-icon](assets/toolkit-icon.png)|
...
|27| Tab Meeting Recording and transcript with auto recording |This sample demonstrates how to automatically record meetings and generate transcripts in Microsoft Teams. |[View][tab-meeting-auto-recording#csharp]||
...
|4|Messaging extensions - action | Demo app for using Action-Based Messaging Extensions in Microsoft Teams.| [View][msgext-action#cs] | [View][msgext-action#js] ![toolkit-icon](assets/toolkit-icon.png) | [View][msgext-action#python] | [View][msgext-action#java]|[View](/samples/msgext-action/csharp/demo-manifest/msgext-action.zip)
...
|10|Messaging Extensions AI - Sentiment Analysis | This sample demonstrates how to analyze the sentiment of chat messages in Teams using a messaging extension powered by Azure Open AI. |[View][msgext-ai-sentiment-analysis#cs] | [View][msgext-ai-sentiment-analysis#js] ![toolkit-icon](assets/toolkit-icon.png) | | |
