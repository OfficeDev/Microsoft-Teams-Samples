...
urlFragment: officedev-microsoft-teams-samples-RT-sample-app-nodejs-oneway-dependency
---
...
1) Clone the repository
    ...
    ```
2) In a terminal, navigate to `samples/RT-sample-app/nodejs-oneway-dependency`
...
<img src="https://pnptelemetry.azurewebsites.net/microsoft-teams-samples/samples/RT-sample-app-nodejs-oneway-dependency" />