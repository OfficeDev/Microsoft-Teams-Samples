...
from botbuilder.schema import HeroCard, CardImage, CardAction, ActionTypes,SigninCard,OAuthCard
import os
...
def oauth_Card():
    return CardFactory.oauth_card(
        OAuthCard(
            connection_name=os.getenv("ConnectionName"),  # Your Azure bot connection name
