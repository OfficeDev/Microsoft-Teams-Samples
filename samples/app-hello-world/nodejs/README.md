...
- Microsoft Teams, with a non-guest account, installed.
- NodeJS (version 16.14.2 or higher) on your development machine.
...
- [M365 developer account](https://docs.microsoft.com/microsoftteams/platform/concepts/build-and-test/prepare-your-o365-tenant) or access to a Teams account with permission to install apps.
...
4. Sign in with your Microsoft 365 account with permission to upload custom apps using the extension.
...
4. Update `custom-environment-variables` and `default` configurations for bot App ID, App Password, and Base URL.
5. Run the app:
...
- Zip contents into `manifest.zip` or `Manifest_Hub.zip` for Office multiple hub environments testing.
...
> Desktop testing is available on the Office 365 app.
