...
namespace TabActivityFeed.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<ActionResult> SendNotificationToUser(TaskDetails taskModuleData)
        {
            ...
            var user = await graphClient.Users[taskModuleData.userName]
                      .Request()
                      .GetAsync();
            ...
            if (taskModuleData.taskInfoAction == "customTopic")
            {
                ChatMessageHelper chatMessage = new ChatMessageHelper(_configuration);
                var getChannelMessage = await chatMessage.CreateChatMessageForChannel(taskModuleData, taskModuleData.access_token);
        ...
        public async Task<ActionResult> SendNotificationToGroupChat(TaskDetails taskModuleData)
        {
            ...
            {
                ChatMessageHelper chatMessage = new ChatMessageHelper(_configuration);
                var getChatMessage = chatMessage.CreateGroupChatMessage(taskModuleData, taskModuleData.access_token);
                var customTopic = new TeamworkActivityTopic
                {
                    Source = TeamworkActivityTopicSource.EntityUrl,
                    Value = "https://graph.microsoft.com/beta/chats/" + taskModuleData.chatId + "/messages/" + getChatMessage.Id
                };
                ...
                try
                {
                    await graphClientApp.Chats[taskModuleData.chatId]
            ...
            else
            {
                ...
                {
                    Source = TeamworkActivityTopicSource.EntityUrl,
                    Value = "https://graph.microsoft.com/beta/chats/" + taskModuleData.chatId
                };
        ...
        public async Task<ActionResult> sendNotificationToTeam(TaskDetails taskModuleData)
        {
            ...
            if (taskModuleData.taskInfoAction == "customTopic")
            {
                ...
                try
                {
                    await graphClientApp.Teams[taskModuleData.teamId]
                          .SendActivityNotification(customTopic, CustomActivityType, null, CustomPreviewText, CustomTemplateParameters, customRecipient)
                          .Request()
                          .PostAsync();
                }
            ...
            else if (taskModuleData.taskInfoAction == "channelTab")
            {
                ChatMessageHelper chatMessage = new ChatMessageHelper(_configuration);
                var getChannelMessage = chatMessage.CreateChannelMessageAdaptiveCard(taskModuleData, taskModuleData.access_token);

                var tabs = await graphClient.Teams[taskModuleData.teamId].Channels[taskModuleData.channelId].Tabs
                .Request()
                .Expand("teamsApp")
                .GetAsync();
                ...
                {
                    Source = TeamworkActivityTopicSource.EntityUrl,
                    Value = "https://graph.microsoft.com/beta/teams/" + taskModuleData.teamId + "/channels/" + taskModuleData.channelId + "/tabs/" + tabId
                };
                ...
                {
                  Name = "reservationId",
                  Value =taskModuleData.reservationId
                 },
                  new Microsoft.Graph.KeyValuePair
                {
                  Name = "currentSlot",
                  Value =taskModuleData.currentSlot
                 }
               };
                try
                {
            ...
            {
                ChatMessageHelper chatMessage = new ChatMessageHelper(_configuration);
                var getChannelMessage = await chatMessage.CreatePendingFinanceRequestCard(taskModuleData, taskModuleData.access_token);
