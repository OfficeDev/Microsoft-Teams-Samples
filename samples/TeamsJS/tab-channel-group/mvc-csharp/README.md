---
page_type: sample
description: This quickstart guide shows how to create custom channel and group tabs for Microsoft Teams with ASP.NET Core and MVC. It covers the complete setup process, including manifest configuration and local testing using tools like Ngrok and the Microsoft 365 Agents Toolkit  for Visual Studio.
products:
- office-teams
- office
- office-365
