...
from bots import MeetingContextApp
...
FILE_PATHS = {"tab": "src/views/tab.html", "configure": "src/views/configure.html"}

# aiohttp route for home page
async def tab(request):
    """Handles requests to the home page."""
    return web.FileResponse(FILE_PATHS["tab"])
