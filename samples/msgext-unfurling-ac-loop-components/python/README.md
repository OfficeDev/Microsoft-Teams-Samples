---
page_type: sample
description: This sample demonstrates a Python Messaging Extension for Microsoft Teams that utilizes adaptive card-based loop components, enabling link unfurling and dynamic interactions within the compose area.
products:
- office-teams
- office
- office-365
...
urlFragment: officedev-microsoft-teams-samples-msgext-unfurling-ac-loop-components-python
---

# Messaging Extension with Adaptive Card Loop Components (Python)
...
1) In a terminal, navigate to `samples/msgext-unfurling-ac-loop-components/python`
...
**Note**: If you are facing any issue in your app, you can add debugging statements in the `app.py` file for local debugging.
