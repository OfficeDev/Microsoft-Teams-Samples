    ...
    public class AuthBot<T> : ActivityBot<T> where T : Dialog
    {
        ...
        protected override async Task OnMembersAddedAsync(IList<ChannelAccount> membersAdded, ITurnContext<IConversationUpdateActivity> turnContext, CancellationToken cancellationToken)
        {
            foreach (var member in turnContext.Activity.MembersAdded)
            {
                ...
                {
                    await turnContext.SendActivityAsync(MessageFactory.Text($"Hello and welcome! With this sample you can fetch attachments to get started send 'login' to get logged in and installed the app in groupchat and team to use the app."), cancellationToken);
                }
            }
        }
