...
4) In a terminal, go to `samples\tab-app-navigation`
...
8)  **Update Placeholder For External App ID**
...
<img src="https://pnptelemetry.azurewebsites.net/microsoft-teams-samples/samples/tab-app-navigation-python" />