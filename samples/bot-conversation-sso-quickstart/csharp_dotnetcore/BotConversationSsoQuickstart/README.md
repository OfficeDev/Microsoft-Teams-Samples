...
### 1. Setup for Bot SSO
Refer to [Bot SSO Setup document](https://github.com/OfficeDev/Microsoft-Teams-Samples/blob/v-chets/sample_fixes/samples/bot-conversation-sso-quickstart/BotSSOSetup.md).
