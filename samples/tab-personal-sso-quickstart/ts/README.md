...
3. Setup for code
   ...
   A) In a terminal, navigate to `samples/tab-personal-sso-quickstart/ts/`
   ...
   B) In a different terminal, navigate to `samples/tab-personal-sso-quickstart/ts/api-server`  
