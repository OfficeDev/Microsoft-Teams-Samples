...
This sample demonstrates a Teams bot that sends proactive messages using the Teams SDK, including:

- **Conversation Id Capture** - Store the conversation id from an install activity so the bot can message the user later
- **Immediate Proactive Messages** - Send a message to a stored conversation at any time without an incoming turn
- **Delayed Proactive Notifications** - Queue a reminder and deliver it after a delay without the user prompting the bot
- **Conversation Storage** - Map a user's Microsoft Entra object id to their conversation id for later use
...
|----------|-----------|-----------|
| C# | .NET 10 / ASP.NET Core | [dotnet](dotnet/bot-proactive-message/README.md) |
| TypeScript | Node.js | [nodejs](nodejs/bot-proactive-message/README.md) |
| Python | Python | [python](python/bot-proactive-message/README.md) |
...
- [Send proactive messages](https://learn.microsoft.com/en-us/microsoftteams/platform/bots/how-to/conversations/send-proactive-messages) - Overview of proactive messaging in bot messages
