...
namespace Microsoft.Teams.Samples.UserSpecificViews.Cards
{
    ...
    {
        private const string SelectCardTypeCardTemplatePath = "select-card-type.json";
        private const string RefreshSpecificUserViewCardTemplatePath = "refresh-specific-user.json";
        private const string RefreshAllUsersViewCardTemplatePath = "refresh-all-users.json";
        private const string UpdatedBaseCardTemplatePath = "updated-base-card.json";
        ...
        private static AdaptiveCardTemplate GetCardTemplate(string templateFileName)
        {
            var templatePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "assets", "templates", templateFileName);
