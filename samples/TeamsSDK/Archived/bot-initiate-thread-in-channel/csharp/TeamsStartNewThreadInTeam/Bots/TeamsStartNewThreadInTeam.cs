...
namespace Microsoft.BotBuilderSamples.Bots
{
    public class TeamsStartNewThreadInTeam : ActivityHandler
    {
        ...
        protected override async Task OnMessageActivityAsync(ITurnContext<IMessageActivity> turnContext, CancellationToken cancellationToken)
        {
            ...
            {
                await GetPagedTeamMembersAsync(turnContext, cancellationToken);
            }
            else
            {
        ...
        private async Task GetPagedTeamMembersAsync(ITurnContext<IMessageActivity> turnContext, CancellationToken cancellationToken)
        {
            try
            {
                var teamId = turnContext.Activity.TeamsGetTeamInfo().Id;
