...
class TeamsBot extends TeamsActivityHandler {
  ...
  async onInvokeActivity(context) {
    if (context._activity.name === 'application/search') {
      ...
      try {
        const response = await axios.get(`http://registry.npmjs.com/-/v1/search?${new URLSearchParams({ text: searchQuery, size: 8 })}`);
        ...
        await context.sendActivity("We couldn't find any packages matching your search. Try refining your search.");
