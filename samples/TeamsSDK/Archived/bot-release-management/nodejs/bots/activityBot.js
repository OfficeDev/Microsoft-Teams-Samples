...
class ActivityBot extends ActivityHandler {
    constructor() {
      ...
      const isPresent = Object.prototype.hasOwnProperty.call(global.taskDetails, Constant.TaskDetails);
      if (isPresent && context.activity.membersAdded && context.activity.membersAdded.length > 0)
            {
        const details = global.taskDetails[Constant.TaskDetails];
        const cardJson = {
