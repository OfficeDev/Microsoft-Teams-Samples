...
5) In a terminal, go to `samples\bot-configuration-app-auth`
...
<img src="https://pnptelemetry.azurewebsites.net/microsoft-teams-samples/samples/TeamsSDK/Archived/bot-configuration-app-auth-python" />