...
5) In a terminal, go to `samples\app-region-selection`
...
<img src="https://pnptelemetry.azurewebsites.net/microsoft-teams-samples/samples/TeamsSDK/Archived/app-region-selection-python" />