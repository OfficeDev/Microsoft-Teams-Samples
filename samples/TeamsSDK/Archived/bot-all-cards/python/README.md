...
3) In a terminal, navigate to `samples/TeamsSDK/Archived/bot-all-cards/python`
...
<img src="https://pnptelemetry.azurewebsites.net/microsoft-teams-samples/samples/TeamsSDK/Archived/bot-all-cards-python" />