...
namespace JoinTeamByQR.Bots
{
    public class ActivityBot<T> : TeamsActivityHandler where T : Dialog
    {
        ...
        protected override async Task OnMessageActivityAsync(ITurnContext<IMessageActivity> turnContext, CancellationToken cancellationToken)
        {
            ...
            {
                await turnContext.SendActivityAsync(MessageFactory.Text("Type 'generate' to get card with generate action."), cancellationToken);
            }
        }
        ...
        protected override async Task<TaskModuleResponse> OnTeamsTaskModuleSubmitAsync(ITurnContext<IInvokeActivity> turnContext, TaskModuleRequest taskModuleRequest, CancellationToken cancellationToken)
        {
            ...
            await turnContext.SendActivityAsync(MessageFactory.Text("User added to team successfully"), cancellationToken);
            return null;
        }
    }
}