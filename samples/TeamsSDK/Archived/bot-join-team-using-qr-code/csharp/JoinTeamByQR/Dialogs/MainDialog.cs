...
namespace JoinTeamByQR.Dialogs
{
    public class MainDialog : LogoutDialog
    {
            ...
            : base(nameof(MainDialog), configuration["ConnectionName"])
        {
            ...
            AddDialog(new TokenExchangeOAuthPrompt(
                ...
                new OAuthPromptSettings
                {
                    ...
                    Text = "Please login",
                    Title = "Sign In",
                    Timeout = 1000 * 60 * 5, // User has 5 minutes to login
                }));
        ...
        private async Task<DialogTurnResult> LoginStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            if (tokenResponse != null && stepContext.Context.Activity.Text?.ToLower().Trim() == "generate")
            {
                // Store the token for later use
                _Token.AddOrUpdate("Token", tokenResponse.Token, (_, _) => tokenResponse.Token);
