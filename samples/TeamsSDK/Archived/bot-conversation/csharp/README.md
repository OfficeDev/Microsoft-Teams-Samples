...
1) If you are using Visual Studio
   ...
   - Navigate to `samples/TeamsSDK/Archived/bot-conversation/csharp` folder
...
**Note**: If you are facing any issue in your app, please uncomment [this](https://github.com/OfficeDev/Microsoft-Teams-Samples/blob/main/samples/TeamsSDK/Archived/bot-conversation/csharp/AdapterWithErrorHandler.cs#L25) line and put your debugger for local debug.
...
<img src="https://pnptelemetry.azurewebsites.net/microsoft-teams-samples/samples/TeamsSDK/Archived/bot-conversation-csharp" />
