...
- In the folder where the repository is cloned, navigate to `samples/TeamsSDK/Archived/bot-daily-task-reminder/python`
...
<img src="https://pnptelemetry.azurewebsites.net/microsoft-teams-samples/samples/TeamsSDK/Archived/bot-daily-task-reminder-python" />