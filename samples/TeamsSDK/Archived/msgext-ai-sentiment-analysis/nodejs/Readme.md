...
CHAT_COMPLETION_MODEL_NAME=<<Your Azure OpenAI Deployment Name (e.g. gpt-4o)>>
```
...
1) Install modules
    ...
    npm install
    ```
1) Update the `.env` configuration for the bot to use the `MicrosoftAppId`, `MicrosoftAppPassword`, `SECRET_AZURE_OPENAI_API_KEY`, `AZURE_OPENAI_ENDPOINT`, `AZURE_OPENAI_API_VERSION`, `CHAT_COMPLETION_MODEL_NAME`, and `BaseUrl` with your tunnel URL. (Note: `MicrosoftAppId` is the AppId created when registering your bot, and `MicrosoftAppPassword` is the corresponding client secret.)
...
`"name": "SECRET_AZURE_OPENAI_API_KEY", "value": "<Your Azure OpenAI API Key>"`

`"name": "AZURE_OPENAI_ENDPOINT", "value": "https://<your-resource-name>.openai.azure.com/"`

`"name": "AZURE_OPENAI_API_VERSION", "value": "2024-10-01-preview"`

`"name": "CHAT_COMPLETION_MODEL_NAME", "value": "<Your Azure OpenAI Deployment Name (e.g. gpt-4o)>"`
