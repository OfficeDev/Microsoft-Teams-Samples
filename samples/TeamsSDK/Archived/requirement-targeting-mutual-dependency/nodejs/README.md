...
-  To test locally, [NodeJS](https://nodejs.org/en/download/) must be installed on your development machine (version 18 or higher)
...
2. Select **New Registration** and on the *register an application page*, set following values:
    ...
    * Choose the **supported account types** as **Accounts in this organizational directory only (Single tenant)**
...
<img src="https://pnptelemetry.azurewebsites.net/microsoft-teams-samples/samples/TeamsSDK/Archived/requirement-targeting-mutual-dependency-nodejs" />