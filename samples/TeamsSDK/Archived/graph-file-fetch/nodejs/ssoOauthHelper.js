...
class SsoOAuthHelper {
     ...
     * @param {TurnContext} turnContext - The turn context for this specific activity.
    ...
    async exchangedToken(turnContext) {
        ...
        try {
            // Use getUserToken instead of exchangeToken
            tokenExchangeResponse = await turnContext.adapter.getUserToken(
                turnContext,
                this.oAuthConnectName,
