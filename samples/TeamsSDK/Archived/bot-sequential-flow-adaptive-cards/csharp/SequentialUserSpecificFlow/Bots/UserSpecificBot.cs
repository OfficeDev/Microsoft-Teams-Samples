    ...
    public class UserSpecificBot : ActivityHandler
    {
        ...
        protected override async Task<InvokeResponse> OnInvokeActivityAsync(ITurnContext<IInvokeActivity> turnContext, CancellationToken cancellationToken)
        {
            ...
            if (turnContext.Activity.Name == "composeExtension/submitAction")
            {
                ...
                var data = (object)asJobject.ToObject<CardTaskFetchValue>()?.Data;
                var botInstalled = (object)JObject.Parse(data.ToString()).ToObject<CardTaskFetchValue>()?.MsTeams;
                ...
                {
                    var incidentId = (string)JObject.Parse(data.ToString()).ToObject<CardTaskFetchValue>()?.IncidentId;
            ...
            if (turnContext.Activity.Name == "adaptiveCard/action")
            {
                ...
                switch (verb)
                {
                    ...
                    case "thirdCard":
                        ...
                        currentIncidentList.Add(incidentDetail);
