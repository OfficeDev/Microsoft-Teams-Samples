...
namespace ChangeNotification.Controllers
{
    ...
    public class NotificationsController : Controller
    {
        ...
        public ActionResult WebhookLifecyle([FromQuery] string validationToken = null)
        {
            ...
            _logger.LogWarning("Received webhook lifecycle notification without validation token.");
            return Ok();
        }
        ...
        {
            var notification = "Change your status to get notification";
            var changeNotificationHelper = new ChangeNotificationHelper();
            ...
            await turnContext.SendActivityAsync(MessageFactory.Text(notification, notification), cancellationToken);
        }
    }
}