...
- To test locally, [NodeJS](https://nodejs.org/en/download/) must be installed on your development machine (version 18.x or higher)
...
### Register you app with Azure AD.
  ...
  14.  Navigate to the **Certificates & secrets**. In the Client secrets section, click on "+ New client secret". Add a description(Name of the secret) for the secret and select â€œNeverâ€ for Expires. Click "Add". Once the client secret is created, copy its value, it need to be placed in the .env.
...
### Instruction on setting connection string for bot authentication on the behalf of user
   ...
   - Complete the form as follows.
    ...
    b. Service Provider. Select **Microsoft Entra ID**.
