...
* [Register an App in AAD that can be used for Teams SSO](https://docs.microsoft.com/en-gb/microsoftteams/platform/tabs/how-to/authentication/tab-sso-register-aad)
