---
page_type: sample
description: This bot sample for Teams demonstrates file upload capabilities using Teams SDh, enabling users to upload files and view inline images within chats.
products:
- office-teams
- office
- office-365
