...
def notifications():
    ...
    # Check for duplicate notifications using the notification ID
    notification_id = notification.get('id')
    if notification_id and notification_id in notification_ids:
        print(f"Duplicate notification detected: {notification_id}")
        return jsonify(notification_list)
    
    # Add notification ID to tracking set
    if notification_id:
...
@app.route('/team-notification')
def team_page():
    return render_template('team-notification.html')
