...
extensions:
 contentType: samples
 createdDate: "08/25/2025 12:00:00 AM"
urlFragment: officedev-microsoft-teams-samples-tab-request-approval-python
---
...
![tab-request-approval ](Images/Tab_Request_Approval.gif)
...
![InstallAppUser1](Images/1.Install_App.png)

- User-1 Create Task

![CreateTask](Images/3.Create_Request.png)

- User-1 Task Details

![TaskDetails](Images/4.When_No_Request.png)

- User-1 All Person

![TaskDetails](Images//5.When_NoApproval_List.png)

- User-1 Select a Person

![TaskDetails](Images//6.Task_Created_Notification.png)

- User-1 Create task Details

![CreateTaskDetails](Images/7.Request_List.png)

- Pending Approvals

![InstallAppUser2](Images/8.Pending_Approvals.png)
