        ...
        this.onMembersAdded(async (context, next) => {
            ...
            for (let member = 0; member < membersAdded.length; member++) {
                if (membersAdded[member].id !== context.activity.recipient.id) {
                    await context.sendActivity('Hello and welcome! With this sample your bot can generate QR code for the selected team and the user will be able to join the team by scanning QR code. Please type hey to begin.');
                }
            }
