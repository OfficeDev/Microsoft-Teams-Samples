...
This sample demonstrates an AI-powered Academic Agent built with the **Teams AI Library for Python** (`teams-ai`). The bot provides comprehensive educational support, career guidance, and course recommendations using OpenAI's GPT models.

> **Note:** This is a Python conversion of the Node.js sample using Teams AI Library. See `CONVERSION_NOTES.md` and `TEAMS_AI_SUMMARY.md` for details.

## Included Features
* **Teams AI Library** - Python version of `@microsoft/teams-ai`
* **OpenAI Integration** - GPT-powered responses
* **Prompt Management** - Structured prompts system
* **State Management** - Automatic conversation state
* **Educational Agent** - Academic guidance and course recommendations

## Architecture

Uses **Teams AI Library for Python** instead of Bot Framework:
- `Application[TurnState]` for bot creation
- Decorator-based event handlers
- Prompt-based AI configuration
