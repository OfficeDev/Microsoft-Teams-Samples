...
const meetingInfoRepository = require('./meetingInfoRepository');
    ...
    constructor() {
        ...
        */
        ...
        this.onConversationUpdate(async (context, next) => {
            ...
            meetingInfoRepository.setConversationReference(conversationReference);
            await next();
        });

        this.onTeamsMembersAddedEvent(async (membersAdded,teamInfo,context,next) => {
            meetingInfoRepository.setMeetingContext(context.activity.conversation.id, context);
            await next();
        });
    }
