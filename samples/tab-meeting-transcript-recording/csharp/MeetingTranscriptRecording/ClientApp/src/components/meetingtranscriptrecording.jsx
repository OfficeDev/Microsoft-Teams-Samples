...
const MeetingTranscriptRecording = () => {
    ...
    // Request consent on implicit grant error.
    const fetchrecordingtranscript = () => {
        alert("Good");
    }
                        ...
                        <Card>
                            <CardBody className="main1Card">
                                <div>
                                    ...
                                    <Text className="txtMeetingTitle" weight='bold' as="h1">Meeting Title</Text>
                                </div>
                                <div>
                                    <Text className="meetingDate">xx-dd-yyyy</Text>
                                </div>
                                <div>
                                    <Text className="organizerName">Organizer Name</Text>
                                </div>
                                <div className="btnCard">
                                    <Button appearance="primary" onClick={fetchrecordingtranscript}>Fetch Recording & Transcript</Button>
                                </div>
                            </CardBody>
                        </Card>
                    </>
