---
page_type: sample
description: This is a sample application which demonstrates use of Channel subscription that will post notifications when user create/edit/delete channel using bot.
products:
- office-teams
- office
- office-365
...
extensions:
contentType: samples
createdDate: "18-08-2022 00:11:15"
---

# This is a sample application that shows the usage of Graph CRUD operations related to team tags.

This is a sample application which demonstrates use of Channel subscription that will post notifications when user create/edit/delete channel.

## Concepts introduced in this sample
- After sucessfully installation of bot in teams you will get a welcome card and the subscription will be created for channel it is installed in.

![Welcome Card](ChannelNotification/Images/Welcome.png)

- When you create channel notiifcation will comes like this in the below image.

![Channel Created](MeetingNotification/Images/Created.png)

- Notifications will also be triggered when channel edited/updated.

![Channel Edited](MeetingNotification/Images/Updated.png)

- Notifications will also be triggered when channel deleted.

![Channel Deleted](MeetingNotification/Images/Deleted.png)
...
1) Clone the repository
  ...
  - File -> Open Folder
  - Navigate to `samples/graph-channel-notification/csharp` folder
  - Select `ChannelNotification` folder
